...
export function registerAnthropicPlugin(api: OpenClawPluginApi): void {
  ...
  api.registerProvider({
    ...
    auth: [
      {
        id: "cli",
        label: "Claude CLI (recommended)",
        hint: "Reuse a local Claude CLI login (subscription billing, no API charges)",
        kind: "custom",
        wizard: {
          choiceId: "anthropic-cli",
          choiceLabel: "Anthropic Claude CLI (recommended)",
          choiceHint: "Reuse a local Claude CLI login on this host — uses Pro/Max subscription, no API billing",
          assistantPriority: 100,
          groupId: "anthropic",
      ...
      },
      {
        ...
        hint: "Deprecated — Anthropic has retired sk-ant-oat01 setup-tokens. Use Claude CLI instead.",
        kind: "token",
        wizard: {
          choiceId: "setup-token",
          choiceLabel: "Anthropic setup-token (deprecated)",
          choiceHint: "Deprecated — switch to Claude CLI auth",
